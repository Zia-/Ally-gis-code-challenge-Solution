...
* Now open the [index.html](https://github.com/Zia-/Ally-gis-code-challenge-Solution/blob/master/web-page/index.html) page, and visualize and appreciate the result. Please try to create something good out of it. :relaxed:
